...
%im=im2double(imread('H:\Jrf Book\image processing\Dr.S.M\New folder\Images\male.tiff'));
...
%im=im2double(imread('H:\Jrf Book\image processing\Dr.S.M\New folder\Images\images\pentagon.tif'));
...
n=4;
BlockSize=16;
[dividedImage,TOTAL_BLOCKS]=divideIntoNonOverlapBlocks(im1,BlockSize);
syms x;
k=2;
for j=1:n
    p(x)=(x^2-1)^k;
...
%         c0=c0+1/2*PolynomialMatrix(i,1)*im2(i)
%         c1=c1+3/2*PolynomialMatrix(i,2)*im2(i)
%         c2=c2+5/2*PolynomialMatrix(i,3)*im2(i)
%         c3=c3+7/2*PolynomialMatrix(i,4)*im2(i)
%     end
...
for p=1:(C/BlockSize)%(C/BlockSize)
    for q=1:(R/BlockSize)
        im11=dividedImage(:,:,COUNT);
        im2 = reshape(im11,BlockSize*BlockSize,1);

        
        x1=PolynomialMatrix_1*im2;
        %PolynomialMatrix*x1;
        ran=randi(factorial(n),1);
        
        s1=PolynomialMatrix(:,V_matrix(ran,1))*x1(1)+ PolynomialMatrix(:,V_matrix(ran,1))*x1(V_matrix(ran,1))-PolynomialMatrix(:,V_matrix(ran,4))*x1(4)+(im2-PolynomialMatrix*x1)/n;
        s2=PolynomialMatrix(:,V_matrix(ran,2))*x1(2)+ PolynomialMatrix(:,V_matrix(ran,2))*x1(V_matrix(ran,2))-PolynomialMatrix(:,V_matrix(ran,3))*x1(3)+(im2-PolynomialMatrix*x1)/n;         
        s3=PolynomialMatrix(:,V_matrix(ran,3))*x1(3)+ PolynomialMatrix(:,V_matrix(ran,3))*x1(V_matrix(ran,3))-PolynomialMatrix(:,V_matrix(ran,2))*x1(2)+(im2-PolynomialMatrix*x1)/n;
        s4=PolynomialMatrix(:,V_matrix(ran,4))*x1(4)+ PolynomialMatrix(:,V_matrix(ran,4))*x1(V_matrix(ran,4))-PolynomialMatrix(:,V_matrix(ran,1))*x1(1)+(im2-PolynomialMatrix*x1)/n;   

%         s1=PolynomialMatrix(:,V_matrix(ran,1))*x1(1)+ PolynomialMatrix(:,V_matrix(ran,1))*x1(V_matrix(ran,1))-PolynomialMatrix(:,V_matrix(ran,2))*x1(2)+(im2-PolynomialMatrix*x1)/n;
%         s2=PolynomialMatrix(:,V_matrix(ran,2))*x1(2)+ PolynomialMatrix(:,V_matrix(ran,2))*x1(V_matrix(ran,2))-PolynomialMatrix(:,V_matrix(ran,3))*x1(3)+(im2-PolynomialMatrix*x1)/n;         
%         s3=PolynomialMatrix(:,V_matrix(ran,3))*x1(3)+ PolynomialMatrix(:,V_matrix(ran,3))*x1(V_matrix(ran,3))-PolynomialMatrix(:,V_matrix(ran,1))*x1(1)+(im2-PolynomialMatrix*x1)/n;
%       s4=PolynomialMatrix(:,V_matrix(ran,4))*x1(4)+ PolynomialMatrix(:,V_matrix(ran,4))*x1(V_matrix(ran,4))-PolynomialMatrix(:,V_matrix(ran,1))*x1(1)+(im2-PolynomialMatrix*x1)/n; 
%         s1=PolynomialMatrix(:,1)*x(1,1);%+(im2-PolynomialMatrix*c0)/n;
%         s2=PolynomialMatrix(:,2)*x(2,1);%+(im2-PolynomialMatrix*c1)/n;         
%         s3=PolynomialMatrix(:,3)*x(3,1);%+(im2-PolynomialMatrix*c2)/n;
%         s4=PolynomialMatrix(:,4)*x(4,1);%+(im2-PolynomialMatrix*c3)/n;        
        ...
        SS1(startrow : endrow, startcol : endcol)=ss1;
        SS2(startrow : endrow, startcol : endcol)=ss2;
        SS3(startrow : endrow, startcol : endcol)=ss4;         
        SS4(startrow : endrow, startcol : endcol)=ss3;
        ...
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss1;
        SS2(startrow : endrow, startcol : endcol)=ss4;
        SS3(startrow : endrow, startcol : endcol)=ss2;
        SS4(startrow : endrow, startcol : endcol)=ss3;
        ...
        SS2(startrow : endrow, startcol : endcol)=ss4;
        SS3(startrow : endrow, startcol : endcol)=ss3;
        SS4(startrow : endrow, startcol : endcol)=ss2;
        ...
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss1;
        SS2(startrow : endrow, startcol : endcol)=ss3;
        SS3(startrow : endrow, startcol : endcol)=ss4;
        SS4(startrow : endrow, startcol : endcol)=ss2;
        ...
        endrow = startrow + BlockSize -1;
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss2;
        SS2(startrow : endrow, startcol : endcol)=ss3;
        SS3(startrow : endrow, startcol : endcol)=ss4;
        SS4(startrow : endrow, startcol : endcol)=ss1;
        ...
        SS1(startrow : endrow, startcol : endcol)=ss2;
        SS2(startrow : endrow, startcol : endcol)=ss3;
        SS3(startrow : endrow, startcol : endcol)=ss1;
        SS4(startrow : endrow, startcol : endcol)=ss4;
        ...
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss2;
        SS2(startrow : endrow, startcol : endcol)=ss1;
        SS3(startrow : endrow, startcol : endcol)=ss3;
        SS4(startrow : endrow, startcol : endcol)=ss4;
        ...
        endrow = startrow + BlockSize -1;
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss3;
        SS2(startrow : endrow, startcol : endcol)=ss1;
        SS3(startrow : endrow, startcol : endcol)=ss2;
        SS4(startrow : endrow, startcol : endcol)=ss4;
        ...
        endrow = startrow + BlockSize -1;
        endcol = startcol + BlockSize-1;
        SS1(startrow : endrow, startcol : endcol)=ss4;
        SS2(startrow : endrow, startcol : endcol)=ss1;
        SS3(startrow : endrow, startcol : endcol)=ss2;
        SS4(startrow : endrow, startcol : endcol)=ss3;
...
%tic
SS=SS1+SS2+SS3+SS4;
%+SS5;%+SS6+SS7+SS8+SS9+SS10+SS11+SS12+SS13+SS14+SS15+SS16;
figure(2)
imshow(mat2gray(SS1));
% entropy_ss1=entropy(SS1)
 imwrite(SS1,'share1_1.png');
figure(3)
imshow(mat2gray(SS2));
% entropy_ss2=entropy(SS2)
 imwrite(SS2,'share2_1.png');
figure(4)
imshow(mat2gray(SS3));
% entropy_ss3=entropy(SS3)
 imwrite(SS3,'share3_1.png');
figure(5)
imshow(mat2gray(SS4));
% entropy_ss4=entropy(SS4)
 imwrite(SS4,'share4_1.png');
% figure(6)
% imshow(mat2gray(SS1+SS2));
% entropy_ss12=entropy(SS1+SS2);
% figure(7)
% imshow(mat2gray(SS1+SS2+SS3));
% entropy_ss123=entropy(SS1+SS2+SS3)
% figure(8)
...
% figure(14)
% imshow(mat2gray(SS1+SS3+SS4));
% figure(15)
% imshow(mat2gray(SS1+SS3));
figure(16)
histogram(single(SS1));
% figure(17)
% imshow(mat2gray(SS));
[count,grayvalue]=imhist((SS));
Sort_count=sort(count);
m1=Sort_count(128);
for i = 1:R
    for j=1:C
         i2=mod(((m1+1)*(i-1)-(j-1)),R)+1;
         j2=mod((-m1*(i-1)+(j-1)),R)+1; 
         im3(i2,j2)=SS(i,j);
    end
end
%toc
...
%SS1(1,1)=1;
% [digest_s1, MSG_RAW_S1] = hash1(SS1);
% digest_s1
% MSG_RAW_S1
% 
% [digest_s2, MSG_RAW_S2] = hash1(SS2);
% 
% digest_s2
% MSG_RAW_S2
% 
% [digest_s3, MSG_RAW_S3] = hash1(SS3);
% digest_s3
% MSG_RAW_S3
% [digest_s4, MSG_RAW_S4] = hash1(SS4);
% digest_s4
% MSG_RAW_S4
% 
% [digest_main, MSG_RAW_main] = hash1(SS);
% 
% [digest_S12, MSG_RAW_S12] = hash2(digest_s1,digest_s2);
% [digest_S34, MSG_RAW_S34] = hash2(digest_s3,digest_s4);
% digest_S12
% digest_S34
% [digest_S1234, MSG_RAW_S1234] = hash2(digest_S12,digest_S34);
% digest_S1234
% 
% 
% function [digest, MSG_RAW_512] = hash1(IMAGE)
...
% im=IMAGE;%im2bw(imread('H:\Jrf Book\image processing\Dr.S.M\New folder\Images\abc.bmp'));
% %LEN=size(im,1)*size(im,2)*8;%448;
...
% %mesg_d(k-4)=0;
% if(LEN>0)
% for i=1:size(im,1)*size(im,2)%size(msg_str,1)*size(msg_str,2)%length(mesg_d)
%    %msg_str(i)
...
% %msg_str;
% elseif(GEN==0) 
% %fid = fopen('H:\Jrf Book\image processing\Dr.S.M\New folder\Images\wen.bmp', 'r');
...
% for i=1:length(MESG)
%     MESG(i);
%     msg_str=strcat(msg_str,dec2bin(MESG(i),8));      
% end
% size(msg_str);
% % length(MESG)*4
% % LEN
...
% end
% 
% function [digest, MSG_RAW_512] = hash2(IMAGE1,IMAGE2)
% %function [digest, MSG_PADDED] = hash(LEN,METH,GEN)
% % hash(LEN,METH,GEN)
% % Generates Message Digest using algorithms : SHA1, SHA-224, SHA256
% % Currently implemented only SHA-1
...
% %GEN=1;
% %% const. for SHA224 & SHA256
% %im=(imread('H:\Jrf\image processing\Dr.S.M\New folder\Images\lena.bmp'));
% im1=IMAGE1;%'4FFD6205B0233CC1106BABAF6AC06B02986A1CF2080FF2004B94132EB4F7A67A';
% im2=IMAGE2;%'9F419283B8DC9D9D546E86934BD9B2681C34FDED86DDE281609474DA63FFE461';
% im=strcat(im1,im2)%im2bw(imread('H:\Jrf Book\image processing\Dr.S.M\New folder\Images\abc.bmp'));
% %LEN=size(im,1)*size(im,2)*8;%448;
% LEN=length(im);
% %LEN=size(im,1)*size(im,2);
% METH='SHA256';
